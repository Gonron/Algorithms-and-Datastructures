...
namespace SearchingShakespeare {
    public static class TextProcessor {
        ...
        public static string ReadText(string path = @"C:\CPHBusiness\Algorithms-and-Datastructures\csharp\Project\SearchingShakespeare\shakespeare-complete-works.txt") {
            try {
